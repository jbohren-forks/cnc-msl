...
#include "simulator/csim-0.1.0/server/controllers/position2d/differential/Differential_Position2d.hh"
...
void Differential_Position2d::LoadChild(/*XMLConfigNode *node*/)
{
  ...
  this->wheelSepP->Load();
  this->wheelDiamP->Load();
  this->torqueP->Load();

  this->leftJointNameP->Load();
  this->rightJointNameP->Load();
