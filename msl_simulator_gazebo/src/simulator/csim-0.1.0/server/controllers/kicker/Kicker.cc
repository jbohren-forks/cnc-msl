...
#include "simulator/csim-0.1.0/server/physics/SphereShape.hh"

#include "simulator/csim-0.1.0/server/sensors/barrier/BarrierSensor.hh"
#include "simulator/csim-0.1.0/server/controllers/kicker/Kicker.hh"
...
//  TODO XML STUFF
  this->kickerTilt = DTOR (45.0);//(node->GetFloat("tilt", 45.0, 0 ) );
  this->highDistance =  12;//node->GetFloat("highDistance", 12, 0);
  this->lowVel  = 11.5; //node->GetFloat("lowVel", 11.5, 0);
