...
//    gzthrow("Field section is missing\n");
  ...
  this->fieldLength = 0.0; //node->GetDouble("fieldLength", 0.0, 1 );
  this->fieldWidth  = 0.0; //node->GetDouble("fieldWidth",  0.0, 1 );
  
  this->centerCircleRadius = 0.0;//node->GetDouble("centerCircleRadius",  0.0, 1 );
  
  this->goalieAreaWidth  = 0.0; //node->GetDouble("goalieAreaWidth",  0.0, 1 );
  this->goalieAreaLength = 0.0; //node->GetDouble("goalieAreaLength", 0.0, 1 );
  
  this->penaltyAreaWidth  = 0.0; //node->GetDouble("penaltyAreaWidth",  0.0, 1 );
  this->penaltyAreaLength = 0.0; //node->GetDouble("penaltyAreaLength", 0.0, 1 );
  
  this->north = 0.0; //node->GetDouble("north", 90.0, 0);
