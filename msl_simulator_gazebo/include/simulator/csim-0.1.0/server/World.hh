...
#include "simulator/csim-0.1.0/server/Vector2.hh"
...
//  TODO: XML STUFF XMLConfigNode *rootNode
  public: void Load(unsigned int serverId);
...
//  TODO: XML STUFF XMLConfigNode *node
  public: void LoadEntities(Model *parent, bool removeDuplicate);
  ...
  //TODO XML STUFF
  private: Model *LoadModel(Model *parent, bool removeDuplicate);
